...
#define VOICE_PATH "/tmp/asr.wav" //存放语音文件的路径

char* result_backup = NULL;
...
static RETURN_CODE fill_config(struct asr_config *config) {
    ...
    char api_key[] = "RZcMP8Nj9aY4QjiYOGc9QG5K";
    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    char secret_key[] = "SWfZw9Al9BSi1UWXvmky5KUxvGlaPAlw";
    // 需要识别的文件
    char *filename = VOICE_PATH;
...
int asrmain() {
    printf("baidu voice asr program start\n");
